...
| **Хранение пути в БД** | Максимальная производительность, простота, легко кешировать | Потеря гарантий целостности (Файл можно удалить вручную) | **Чаще всего是最好的 практика.** Файлы на диске/NFS, а в БД — только метаданные и путь |

---

### 1. Тип `bytea` — Простое хранение "в строке"

Это самый straightforward способ. Вы сохраняете содержимое файла как двоичную строку прямо в колонке таблицы.
